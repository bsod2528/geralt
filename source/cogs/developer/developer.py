...
class Developer(commands.Cog):
    ...
    def emote(self) -> discord.PartialEmoji:
        return discord.PartialEmoji(
            name="Dev", id=905750348457738291, animated=True)
    ...
    async def add_to_blacklist(self, ctx: GeraltContext, snowflake: discord.Object, reason: str, url: str):
    ...
    async def remove_from_blacklist(self, ctx: GeraltContext, snowflake: discord.Object):
    ...
    @commands.cooldown(2, 5, commands.BucketType.user)
    async def blacklist_add(self, ctx: GeraltContext, snowflake: discord.Object, *, reason: str = None) -> Optional[discord.Message]:
    ...
    @commands.cooldown(2, 5, commands.BucketType.user)
    async def blacklist_remove(self, ctx: GeraltContext, snowflake: discord.Object) -> Optional[discord.Message]:
