...
class TicketSetup(discord.ui.View):
    ...
    @discord.ui.button(label="Ticket Message Setup",
                       style=discord.ButtonStyle.grey,
                       emoji="<:AppWindow:987319960059674635>")
    ...
    async def call_ticket(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            try:
                ...
                message_description = [
                    data["message_description"] for data in fetch_ticket_deets]
            except KeyError:
            ...
            try:
                ...
                self.bot.ticket_kernel[interaction.guild.id] = [
                    ticket_id, interaction.user.id, interaction.created_at]
