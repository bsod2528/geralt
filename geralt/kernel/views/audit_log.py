...
class MainAuditLog(discord.ui.View):
    def __init__(
        self, bot: BaseBot, ctx: BaseContext, sent_message_id: discord.Message
    ):
    ...
    options: List[discord.SelectOption] = [
        discord.SelectOption(
            label="Members",
            value="members",
            description="on the nembers.",
            emoji="<:Members:1044584952873898066>",
        ),
        discord.SelectOption(
            label="Moderation",
            value="mod",
            description="moderation activites occurred.",
            emoji="<:BanHammer:1044586305213972590>",
        ),
        discord.SelectOption(
            label="Emotes",
            value="emotes",
            description="all the emotes .",
            emoji="<:Emote:1044584258578157588>",
        ),
        discord.SelectOption(
            label="Stickers",
            value="stickers",
            description="all the stickers.",
            emoji="<:Sticker:1044997709981032479>",
        ),
        discord.SelectOption(
            label="Messages",
            value="messages",
            description="the messages sent.",
            emoji="<a:Typing:1044587029272461422>",
        ),
    ]

    @discord.ui.select(
        placeholder="Actions taken on / related to . . .",
        options=options,
        max_values=1,
        min_values=1,
        row=1,
    ...
    async def member_move(
        ...
        try:
            ...
            member_move_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            async for log in self.ctx.guild.audit_logs(limit=None):
                ...
                await interaction.followup.edit_message(
                    embed=member_move_emb, message_id=self.sent_message_id
                )
        except (NotFound, HTTPException):
            return

    @discord.ui.button(label="Nickname Changes", style=discord.ButtonStyle.grey)
    async def member_update(
        ...
        try:
            ...
            nickaname_changes_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            async for log in self.ctx.guild.audit_logs(limit=None):
                if log.action is AuditLogAction.member_update:
                    ...
                    after_nickname: Optional[str] = getattr(log.after, "nick", MISSING)
                    ...
                    await interaction.followup.edit_message(
                        embed=nickaname_changes_emb, message_id=self.sent_message_id
                    )
        except (NotFound, HTTPException):
            return
    ...
    async def member_role_update(
        ...
        try:
            ...
            role_update_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            async for log in self.ctx.guild.audit_logs(limit=None):
                ...
                await interaction.followup.edit_message(
                    embed=role_update_emb, message_id=self.sent_message_id
                )
        except (NotFound, HTTPException):
            return

    @discord.ui.button(label="Member Disconnected", style=discord.ButtonStyle.grey)
    async def member_disconnected(
        self, interaction: discord.Interaction, button: discord.ui.Button
    ):
        await interaction.response.defer()
        try:
            ...
            member_disconnected_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            async for log in self.ctx.guild.audit_logs(limit=None):
                ...
                await interaction.followup.edit_message(
                    embed=member_disconnected_emb, message_id=self.sent_message_id
                )
        except (NotFound, HTTPException):
            return
    ...
    async def emote_create(
        ...
        try:
            ...
            emote_create_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            async for log in self.ctx.guild.audit_logs(limit=None):
                ...
                await interaction.followup.edit_message(
                    embed=emote_create_emb, message_id=self.sent_message_id
                )
        except (NotFound, HTTPException):
            return

    @discord.ui.button(label="Emote Update", style=discord.ButtonStyle.grey)
    async def emote_update(
        self, interaction: discord.Interaction, button: discord.ui.Button
    ):
        await interaction.response.defer()
        try:
            ...
            emote_update_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            await interaction.followup.edit_message(
                embed=emote_update_emb, message_id=self.sent_message_id
            )
        except (NotFound, HTTPException):
            return
    ...
    async def emote_delete(
        ...
        try:
            ...
            emote_delete_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            await interaction.followup.edit_message(
                embed=emote_delete_emb, message_id=self.sent_message_id
            )
        except (NotFound, HTTPException):
            return
    ...
    async def sticker_create(
        ...
        try:
            ...
            sticker_create_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            await interaction.followup.edit_message(
                embed=sticker_create_emb, message_id=self.sent_message_id
            )
        except (NotFound, HTTPException):
            return

    @discord.ui.button(label="Sticker Update", style=discord.ButtonStyle.grey)
    async def sticker_update(
        self, interaction: discord.Interaction, button: discord.ui.Button
    ):
        await interaction.response.defer()
        try:
            ...
            sticker_update_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            await interaction.followup.edit_message(
                embed=sticker_update_emb, message_id=self.sent_message_id
            )
        except (NotFound, HTTPException):
            return
    ...
    async def sticker_delete(
        ...
        try:
            ...
            sticker_delete_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            await interaction.followup.edit_message(
                embed=sticker_delete_emb, message_id=self.sent_message_id
            )
        except (NotFound, HTTPException):
            return
    ...
    async def _kick(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            await interaction.followup.edit_message(
                embed=kick_emb, message_id=self.sent_message_id
            )
        except (NotFound, HTTPException):
            return
    ...
    async def _ban(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            await interaction.followup.edit_message(
                embed=ban_emb, message_id=self.sent_message_id
            )
        except (NotFound, HTTPException):
            return
    ...
    async def _unban(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            await interaction.followup.edit_message(
                embed=unban_emb, message_id=self.sent_message_id
            )
        except (NotFound, HTTPException):
            return

    @discord.ui.button(label="Prune", style=discord.ButtonStyle.grey)
    async def member_prune(
        self, interaction: discord.Interaction, button: discord.ui.Button
    ):
        await interaction.response.defer()
        try:
            ...
            member_prune_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            await interaction.followup.edit_message(
                embed=member_prune_emb, message_id=self.sent_message_id
            )
        except (NotFound, HTTPException):
            return
    ...
    async def message_pin(
        ...
        try:
            ...
            message_pin_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            await interaction.followup.edit_message(
                embed=message_pin_emb, message_id=self.sent_message_id
            )
        except (NotFound, HTTPException):
            return
    ...
    async def message_unpin(
        ...
        try:
            ...
            message_unpin_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            await interaction.followup.edit_message(
                embed=message_unpin_emb, message_id=self.sent_message_id
            )
        except (NotFound, HTTPException):
            return
    ...
    async def message_delete(
        ...
        try:
            ...
            message_delete_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            await interaction.followup.edit_message(
                embed=message_delete_emb, message_id=self.sent_message_id
            )
        except (NotFound, HTTPException):
            return

    @discord.ui.button(label="Message Bulk Delete", style=discord.ButtonStyle.grey)
    async def message_bulk_delete(
        ...
        try:
            ...
            message_bulk_delete_emb.set_footer(text=self.footer, icon_url=self.icon_url)
            ...
            async for log in self.ctx.guild.audit_logs(limit=None):
                ...
                await interaction.followup.edit_message(
                    embed=message_bulk_delete_emb, message_id=self.sent_message_id
                )
        except (NotFound, HTTPException):
            return
    ...
    async def bot_add(
        ...
        try:
            ...
            async for log in self.ctx.guild.audit_logs(limit=None):
                ...
                await interaction.followup.edit_message(
                    embed=bot_add_emb, message_id=self.sent_message_id
                )
        except (NotFound, HTTPException):
            return
